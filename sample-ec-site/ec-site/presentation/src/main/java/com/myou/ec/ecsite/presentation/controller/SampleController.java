...
public class SampleController {
    ...
    public SampleController(RestTemplateBuilder restTemplateBuilder, S3Client s3Client,
        ...
        this.restTemplate = restTemplateBuilder.setConnectTimeout(java.time.Duration.ofSeconds(10)).build();
    ...
    public String rest2() {
        ...
        try {
            String result = restTemplate.getForObject(new URI("https://www.google.com/"), String.class);
        } catch (RestClientException | URISyntaxException e) {
            logger.error("error!!", e);
            return "error";
        }
